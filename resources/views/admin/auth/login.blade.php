                ...
                <div class="col-md-4 mt-5 p-3">
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            ...
                            <p class="d-flex justify-content-between"><a href="{{route('admin.register')}}" class="btn text-success">Have you not register? Register</a><a href="#" class="btn text-danger">Forgot</a></p>
                        </div>
                    </div> 
                </div>
            </div>
